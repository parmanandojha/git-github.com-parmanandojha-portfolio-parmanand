...
export default function ProjectNextCountdown({ open, progress, x, y, onCancel, nextTitle }) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto relative flex h-[120px] w-[120px] items-center justify-center">
        <svg
          width="120"
          height="120"
          viewBox="0 0 100 100"
        ...
        <button
          ...
          className="relative z-[1] flex h-11 w-11 items-center justify-center bg-transparent p-0 text-gray-900 transition-opacity duration-300 ease-in-out hover:opacity-70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-400"
